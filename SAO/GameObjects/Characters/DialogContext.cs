...
namespace SAO.GameObjects.Characters
{
    ...
    public class DialogContext
    {
        ...
        public const char DialogNameSepareter = '_';
        //------------------------------------
        ...
        public string DialogCaption
        {
            ...
            set
            {
                ...
                {
                    dialogCaption = DialogFirstName + DialogNameSepareter +
                        DateTime.Now.Year.ToString("0000") + DialogNameSepareter +
                        DateTime.Now.Month.ToString("00") + DialogNameSepareter +
                        DateTime.Now.Day.ToString("00") + DialogNameSepareter +
                        DateTime.Now.Hour.ToString("00") + DialogNameSepareter +
                        DateTime.Now.Minute.ToString("00") + DialogNameSepareter +
                        DateTime.Now.Second.ToString("00") + DialogNameSepareter;
                }
            }
        }
        /// <summary>
        ...
        /// <param name="IsRight">
        /// determine wheter this character should be right side of the dialog or not.
