...
#pragma warning disable IDE0017
    public sealed class Unit
    {
        ...
        #endregion
        //-------------------------------------------------
        #region Ordinary public Methods Region
        /// <summary>
        /// Setting the Unit by a string value.
        /// </summary>
        /// <param name="TheString"></param>
        public void SetTheUnit(string TheString)
        {
            string[] myString = TheString.Split(CharSeparater.ToCharArray(), StringSplitOptions.RemoveEmptyEntries);
            Bil = Convert.ToUInt16(myString[0]);
            Mil = Convert.ToUInt16(myString[1]);
            Kil = Convert.ToUInt16(myString[2]);
            Nil = Convert.ToUInt16(myString[3]);
        }
        ...
        public static Unit ConvertToUnit(StrongString theUnitString)
        {
            ...
            return new Unit()
            {
                Bil = myString[0].ToUInt16(),
                Mil = myString[1].ToUInt16(),
                Kil = myString[2].ToUInt16(),
                Nil = myString[3].ToUInt16()
            };
        }
