...
#pragma warning restore IDE0067
        ...
        public void ChangePosition(TimeSpan _position)
        {
            try
            {
                Position = _position;
        ...
        public void ChangeStream(string _path)
        {
            try
            {
            ...
            try
            {
                ...
                try
                {
                    while (true)
                    {
                        ...
                        while (true)
                        {
                            if (ThereIsConstants.Forming.TheMainForm is null || ThereIsConstants.Forming.TheMainForm.IsDisposed)
                            {
                                break;
                            }
        ...
        internal static WotoAudioPlayer GeneratePlayer(XAudio2 _device, string _path)
        {
#pragma warning disable IDE0068
            var _stream = File.OpenRead(_path);
#pragma warning restore IDE0068
            return new WotoAudioPlayer(_device, ref _stream);
        }
        internal static WotoAudioPlayer GeneratePlayer(XAudio2 _device, ref FileStream _file)
        {
            return new WotoAudioPlayer(_device, ref _file);
        }
        internal static WotoAudioPlayer GeneratePlayer()
        {
