...
{
    partial class ServerBreakSandBox
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            //----------------------------------------------
            this.MyRes = new WotoRes(typeof(ServerBreakSandBox));
            ...
            this.Paint += ServerBreakSandBox_Paint;
            //----------------------------------------------
        ...
        //--------------------------------------
        private void ServerBreakSandBox_Paint(object sender, PaintEventArgs e)
        {
